...
#
# EASIER: just run the go-frog GUI and enter the proxy URL in the "Advanced"
# section of the graphical window. No script needed!
#
# Only use this script if you are running in --cli (terminal) mode.
#
